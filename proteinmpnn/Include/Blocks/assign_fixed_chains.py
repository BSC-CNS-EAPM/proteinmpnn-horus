...
def run_passign_chains(block: PluginBlock):
    ...
    chain_list_value = block.variables[chain_list.id]
    ...
    block.setOutput(output_selected_chains.id, chain_list_value)
...
assign_chains_block = PluginBlock(
    ...
    inputs=[input_parsed_chains],
    variables=[chain_list],
    outputs=[output_fixed_chains, output_selected_chains],
